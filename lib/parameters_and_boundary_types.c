                                       ...
                                       bool* exportData)
{
    ...
    physical_parameters->conductivity.gammax = 1.5;     //conductivity along x coordinate
    physical_parameters->conductivity.gammay = 1.5;     //conductivity along y coordinate
    physical_parameters->conductivity.gammaz = 1.5;     //conductivity along z coordinate
    physical_parameters->Cp                  = 2.0;     //heat capacity
    physical_parameters->rho                 = 1.0;      //density

    boundary_type_faces->west_boundary   = NEUMANN;    //west face boundary type
    boundary_type_faces->east_boundary   = NEUMANN;    //east face boundary type
    boundary_type_faces->south_boundary  = NEUMANN;    //bottom face boundary type
    boundary_type_faces->north_boundary  = NEUMANN;    //north face boundary type
    boundary_type_faces->bottom_boundary = NEUMANN;    //bottom face boundary type
