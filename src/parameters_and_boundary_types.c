                                       ...
                                       bool* exportData)
{
    ...
    grid_size->nx = 21;                                   //amount of nodes along x coordinate
    ...
    physical_parameters->conductivity.gammay = 11.1;     //conductivity along y coordinate
    physical_parameters->conductivity.gammaz = 7.1;     //conductivity along z coordinate
    physical_parameters->Cp                  = 10.0;     //heat capacity
    physical_parameters->rho                 = 10.0;      //density
